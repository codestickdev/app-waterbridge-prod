...
<main class="waterbridge waterbridge--project" projectID="<?php echo get_the_ID(); ?>">
    <section class="projectHeading" style="background-image: url('<?php the_field('project_heading_image'); ?>')">
        ...
        <div class="projectHeading__wrap container">
            <div class="breadcrumb">
                <a href="/"><span>Strona główna</span></a> <a href="/"><span>Panel inwestora</span></a> <a><span class="projectName"><?php the_title(); ?></span></a>
            </div>
            <div class="projectHeading__content">
                ...
                <div class="actionWrap">
                    ...
                    <a class="btn btn--white openInvestForm"><span>Zainwestuj</span></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <section class="projectExpert">
        <div class="projectExpert__wrap">
            ...
            <div class="projectExpert__content">
                <p class="quote">“<?php the_field('projectExpert_quote'); ?>”</p>
    ...
    <!-- Invest form -->
    <?php include get_template_directory() . '/template-parts/_investFormLogged.php'; ?>
</main>
